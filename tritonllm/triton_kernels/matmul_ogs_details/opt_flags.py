...
def make_default_opt_flags_nvidia(
    ...
    from tritonllm.utils import reduce_block_n
    block_n = reduce_block_n(block_n, block_m)
    ...
    from tritonllm.utils import reduce_block_k
    block_k = reduce_block_k(block_k)
